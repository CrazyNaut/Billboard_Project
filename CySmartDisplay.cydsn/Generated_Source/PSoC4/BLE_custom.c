...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* MESSAGE service */
    {
        0x000Cu, /* Handle of the MESSAGE service */ 
        {

            /* MESSAGE Control characteristic */
            {
                0x000Eu, /* Handle of the MESSAGE Control characteristic */ 
            ...
            {
                0x0010u, /* Handle of the SPEED Control characteristic */ 
            ...
            {
                0x0012u, /* Handle of the BRIGHTNESS Control characteristic */ 
